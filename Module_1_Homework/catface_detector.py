# -*- coding: utf-8 -*-
"""
Created on Fri Jun 12 16:37:19 2020
...
face_cascade = cv2.CascadeClassifier('haarcascade_frontalcatface.xml') # We load the cascade for the face.
...
video_capture = cv2.VideoCapture(0) # We turn the webcam on. 0 is pc cam, 1 is external cam
